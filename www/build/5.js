...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DonorsDonationsPageModule", function() { return DonorsDonationsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__donors_donations__ = __webpack_require__(312);
...
var DonorsDonationsPageModule = /** @class */ (function () {
    function DonorsDonationsPageModule() {
    }
    DonorsDonationsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__donors_donations__["a" /* DonorsDonationsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__donors_donations__["a" /* DonorsDonationsPage */]),
            ],
        })
    ], DonorsDonationsPageModule);
    return DonorsDonationsPageModule;
}());

//# sourceMappingURL=donors-donations.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DonorsDonationsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_global_global__ = __webpack_require__(50);
...
var DonorsDonationsPage = /** @class */ (function () {
    function DonorsDonationsPage(global, navCtrl, navParams, http) {
        this.global = global;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.http = http;
    ...
    DonorsDonationsPage.prototype.patients = function () {
        var _this = this;
    ...
    DonorsDonationsPage.prototype.cities = function () {
        var _this = this;
    ...
    DonorsDonationsPage.prototype.donatedOrgans = function () {
        var _this = this;
    ...
    DonorsDonationsPage.prototype.donatedFees = function () {
        var _this = this;
    ...
    DonorsDonationsPage.prototype.viewMore = function (item, id) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__donors_patient_donors_patient__["a" /* DonorsPatientPage */], { 'id': id });
    };
    DonorsDonationsPage.prototype.ionViewDidLoad = function () {
    ...
    DonorsDonationsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-donors-donations',template:/*ion-inline-start:"C:\Pastel18\Install\bymf\src\pages\donors-donations\donors-donations.html"*/'<ion-header>\n    <ion-navbar>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      <ion-title>MoHCC Funding Application ({{this.global.role}}s section) </ion-title>\n    </ion-navbar>\n  </ion-header>\n  \n  <ion-content padding>\n    <ion-grid>\n      <ion-row>\n        <ion-col col-12 style="margin-left: auto;margin-right: auto;display: block;text-align:center;">\n            <h1>My Fees Donations</h1>\n            <div class="row header">\n              <div class="col">Patient</div>\n              <div class="col">Amount</div>\n              <div class="col">Received</div>\n              <div class="col"></div>\n            </div>\n\n            <div class="row" *ngFor="let p of dfs">\n              <div class="col">{{p.patient_name}}</div>\n              <div class="col">ZWL${{p.amount}}</div>\n              <div class="col">\n                  <div *ngIf="p.received == 1; else elseBlock">Yes</div>\n                  <ng-template #elseBlock>Not Yet</ng-template>\n              </div>\n              <div class="col">\n                <div *ngIf="p.campaign == 1; else elseBlock">Via Campaign</div>\n                <ng-template #elseBlock></ng-template>\n            </div>\n            </div>\n        </ion-col>\n      </ion-row>\n      <br><br><br>\n      <ion-row>\n        <ion-col col-12 style="margin-left: auto;margin-right: auto;display: block;text-align:center;">\n              <h1>My Organ Donations</h1>\n              <div class="row header">\n                  <div class="col">Patient</div>\n                  <div class="col">Note</div>\n                  <div class="col">Received</div>\n                </div>\n\n                <div class="row" *ngFor="let p of dos">\n                  <div class="col">{{p.patient_name}}</div>\n                  <div class="col">{{p.note}}</div>\n                  <div class="col">\n                      <div *ngIf="p.received == 1; else elseBlock">Yes</div>\n                      <ng-template #elseBlock>Not Yet</ng-template>\n                  </div>\n                </div>\n\n                 \n          </ion-col>\n      </ion-row>\n      </ion-grid>\n  </ion-content>\n  '/*ion-inline-end:"C:\Pastel18\Install\bymf\src\pages\donors-donations\donors-donations.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_global_global__["a" /* GlobalProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
    ...
    return DonorsDonationsPage;
}());

//# sourceMappingURL=donors-donations.js.map
