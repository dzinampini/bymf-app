...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DonorsLoginPageModule", function() { return DonorsLoginPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__donors_login__ = __webpack_require__(309);
...
var DonorsLoginPageModule = /** @class */ (function () {
    function DonorsLoginPageModule(loadingCtrl, navCtrl, navParams, alertCtrl, http, toastCtrl, storage, global) {
    ...
    DonorsLoginPageModule.prototype.login = function () {
        ...
        this.http.post(this.global.serverAddress + "donors/_login.php", JSON.stringify(this.credentials))
            ...
            var alert = _this.alertCtrl.create({
                title: 'Login Error',
                subTitle: 'Network Error! Please verify your internet connection is working properly and then try again',
                buttons: ['OK']
            });
            alert.present();
        });
    };
    DonorsLoginPageModule.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad DonorsLoginPage');
    };
    DonorsLoginPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__donors_login__["a" /* DonorsLoginPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_7__donors_login__["a" /* DonorsLoginPage */]),
            ],
        }),
    ...
    ], DonorsLoginPageModule);
    return DonorsLoginPageModule;
}());

//# sourceMappingURL=donors-login.module.js.map
